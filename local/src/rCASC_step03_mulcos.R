...
print('############################# scanno2')
scannobyGtf(group = "docker", file=saver_f, gtf.name=GTF, biotype="protein_coding", mt = FALSE, ribo.proteins = FALSE, umiXgene = 3, riboStart.percentage = 0, riboEnd.percentage = 50, mitoStart.percentage = 1, mitoEnd.percentage = 5, thresholdGenes = 100)
