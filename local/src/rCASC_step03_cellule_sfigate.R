...
print('############################# scanno1')
scannobyGtf(group = "docker", file=INPUT, gtf.name=GTF, biotype="protein_coding", mt = FALSE, ribo.proteins = FALSE, umiXgene = 3, riboStart.percentage = 1, riboEnd.percentage = 50, mitoStart.percentage = 1, mitoEnd.percentage = 40, thresholdGenes = 500)
