...
dato_cet$isPaneth[dato_cet$isPaneth=='filtered']<-'Others'
dato_cet$isPaneth[dato_cet$isPaneth=='nPaneth']<-'Others'
dato_cet$isPaneth<-as.factor(dato_cet$isPaneth)

dato_nt$isPaneth<-as.character(dato_nt$isPaneth)
dato_nt$isPaneth[dato_nt$isPaneth=='filtered']<-'Others'
dato_nt$isPaneth[dato_nt$isPaneth=='nPaneth']<-'Others'
