...
paneth <- read.table('/mnt/cold1/snaketree/prj/scRNA/dataset/dataset/KMeans/kmeans/CRC0322_cetux_1/CRC0322_cetux_1_kmeans_2comp.csv', sep=",", row.names=1)
...
panethnt <- read.table('/mnt/cold1/snaketree/prj/scRNA//dataset/KMeans/kmeans/CRC0322_NT_1_3000/CRC0322_NT_1_3000_kmeans_2comp.csv', sep=",", row.names=1)
